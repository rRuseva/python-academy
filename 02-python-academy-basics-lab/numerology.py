messages = [
    ...
    "Да се научим на прецизност в професията. Професии свързани сконструиране, техника, строг ред и дисциплина, спорт.",
...
if __name__ == '__main__':
    ...
    print(print_msg(3, 3, 2001))
    print(print_msg(day, month, year))
