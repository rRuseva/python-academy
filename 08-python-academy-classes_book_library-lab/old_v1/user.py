...
class Admin(User):
    def __init__(self, id=None, fname=None, lname=None,username=None, password=None, roles=["Admin"], books_added =[], users_added = []):
        # class based syntax
...
if __name__ == "__main__":
    u1 = User(0, "jhon", 'dsfsd')
    print(u1)
    a1  = Admin(1, "Default", "Admin")
    print(a1)
